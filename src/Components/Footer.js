    ...
    <div className="w-screen min-h-screen flex items-end justify-center bg-black font-mooli">
            <div className="md:w-11/12 w-full px-4 text-white flex flex-col">
                ...
                <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                    <p className="w-full md:w-2/3 text-gray-400">this line has no meaning.i put it because i love it</p>
                    <div className="w-44 pt-6 md:pt-0">
                        <button className="bg-[#D5F60C] justify-center text-black font-mooli font-semibold text-center rounded-lg shadow px-10 py-3 flex items-center" onClick={()=>{setOpen(true)}}>Contact me</button>
                    </div>
                </div>
